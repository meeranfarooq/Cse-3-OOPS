...
int main()
{
    ...
    cout << "\n\nNote: We cannot use a switch statement here because Richter scale values are real numbers (decimals), and switch only works with integral types (int, char, etc.).";
    return 0;
}
